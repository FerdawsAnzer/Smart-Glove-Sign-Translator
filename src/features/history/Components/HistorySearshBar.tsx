  ...
  return (
    ...
    >
      <CardContent className="p-4 flex items-center gap-3">
        ...
        {/* Export button */}
        <Button className="flex items-center gap-2 rounded-lg text-white border-0 bg-gradient-to-br from-blue-500 to-violet-500 shadow-[0_2px_8px_rgba(99,102,241,0.3)] hover:opacity-90 hover:shadow-[0_4px_12px_rgba(99,102,241,0.4)] hover:-translate-y-px transition-all duration-200">
